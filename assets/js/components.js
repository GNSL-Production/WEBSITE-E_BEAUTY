// Injecte le header et le footer partagés dans les balises <div id="site-header">
// et <div id="site-footer"> présentes sur la page. Doit être chargé (defer) AVANT
// script.js pour que les éléments existent quand celui-ci s'exécute.
(function () {
    ...
    // La section #accueil n'existe que sur la page d'accueil : les liens de nav
    // peuvent alors rester de simples ancres (#services) pour le smooth-scroll
    // et le scrollspy de script.js. Ailleurs, on pointe vers l'accueil + ancre.
