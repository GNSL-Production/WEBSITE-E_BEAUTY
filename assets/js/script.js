    ...
    // Scrollspy: garde le lien de la nav en surbrillance tant qu'on est sur sa section
    ...
    // Recharge la page quand la largeur de fenêtre franchit le breakpoint
    // structurel du hero/nav (768px), pour éviter un layout figé dans un état
    // intermédiaire (ex: colonnes du hero ou menu burger vs nav desktop) après
    // un redimensionnement manuel de la fenêtre.
