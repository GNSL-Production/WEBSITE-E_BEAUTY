...
safeInit('bandeau cookies', () => {
    ...
    banner.innerHTML = `
        <p>Ce site n'utilise pas de cookies de mesure d'audience ni de publicité. Il conserve uniquement votre choix de fermeture de ce bandeau dans le stockage local de votre navigateur. Voir notre <a href="${privacyHref}" rel="noopener noreferrer">politique de confidentialité</a>.</p>
...
safeInit('squelette de chargement Cal.com', () => {
    ...
    // Filet de sécurité : si Cal.com est bloqué (adblock, hors-ligne) ou met
    // trop de temps à répondre, on referme quand même le squelette plutôt que
    // de laisser un scintillement indéfini.
